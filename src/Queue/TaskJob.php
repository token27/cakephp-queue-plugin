...
use Token27\Queue\Transport\Job;
use Token27\Queue\Transport\JobInterface;
use Token27\Queue\Transport\JobTransport;
use Token27\Queue\Model\Table\QueueJobsTable;
use Token27\Queue\Model\Entity\QueueJob;
use Token27\Queue\Shell\Task\QueueJobTask;
//use Token27\Queue\Model\Task\QueueWorker;
...
class TaskJob extends Job {
     ...
     */
    public function __construct(QueueJob $queueTask, QueueWorker $queueWorker = null, $task = null) {
        parent::__construct();
        if ($queueTask === null) {
