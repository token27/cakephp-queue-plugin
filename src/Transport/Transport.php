...
abstract class Transport {
     ...
     * @param \Queue\Queue\QueueInterface $queueInstance Reference to the notification
     *                                                                                instance for a possible callbacks
     *                                                                                callback
     * @return void
     * @throws InvalidArgumentException
     */
    protected static function _performCallback(array $items, JobInterface $queueInstance = null): void {
        $success = false;
